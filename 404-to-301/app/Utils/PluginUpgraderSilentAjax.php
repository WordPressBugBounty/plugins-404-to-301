...
class PluginUpgraderSilentAjax extends \Plugin_Upgrader {
	...
	public $pluginLinks = [
		...
		'duplicatePost'        => 'https://downloads.wordpress.org/plugin/duplicate-post-page-aioseo.zip',
	...
	public $wpPluginLinks = [
		...
		'easyDigitalDownloads' => 'https://wordpress.org/plugins/easy-digital-downloads/',
		'duplicatePost'        => 'https://wordpress.org/plugins/duplicate-post-page-aioseo/',
	...
	public $pluginSlugs = [
		...
		// Matches the wp.org distribution this map downloads, not the monorepo
		// addon directory of the same plugin.
		'brokenLinkChecker'       => 'broken-link-checker-seo/aioseo-broken-link-checker.php',
		'duplicatePost'           => 'duplicate-post-page-aioseo/aioseo-duplicate-post.php',
	...
	public $pluginAdminUrls = [
		...
		'brokenLinkChecker'       => 'admin.php?page=broken-link-checker',
		'duplicatePost'           => 'admin.php?page=duplicate-post-page-aioseo',
		...
		'activeLayer'             => 'plugins.php',
		'reviewsFeed'             => 'plugins.php',
		'uncannyAutomator'        => 'plugins.php',
		'enviraGallery'           => 'plugins.php',
		'userFeedback'            => 'plugins.php',
		'wpChat'                  => 'plugins.php',
		'pdfEmbedder'             => 'plugins.php'
	];
}