...
trait Api {
	...
	private function getWpApiRequestDefaults() {
		return [
			'timeout'    => 10,
			'headers'    => aioseo404To301()->helpers->getApiHeaders(),
			'user-agent' => aioseo404To301()->helpers->getApiUserAgent()
		];
	}
	...
	private function getApiUserAgent() {
		return 'WordPress/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ) . '; AIOSEO/FourNotFour/' . AIOSEO_404_TO_301_VERSION;
	}
}